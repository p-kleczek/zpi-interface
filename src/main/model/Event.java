...
public class Event {
    ...
    /**
     * Zwraca sformatowaną zgodnie z
     * {@link main.util.Settings#EVENT_DATE_FORMAT} datę wydarzenia
     *
     * @return Sformatowana data
     */
    public String getDateString() {
        Date eventDate = getDate().getTime();
        return Settings.EVENT_DATE_FORMAT.format(eventDate);
    }

    @Override
    public String toString() {
        return eventId + ", " + getDateString();
    }
}
