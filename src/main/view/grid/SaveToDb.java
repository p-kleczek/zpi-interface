...
public class SaveToDb implements Executable{
     ...
     */
    @Override
    public Object execute(Connection con, PreparedStatement st, ResultSet rs, List<Object> params) throws SQLException {
        System.out.println("Image: ");
        System.out.println("Rows: " + dataModel.getRows());
        System.out.println("Cols: " + dataModel.getCols());
        System.out.println("Left top point: " + dataModel.getLeftTopPoint().x + ":" + dataModel.getLeftTopPoint().y);
        System.out.println("Left bottom point: " + dataModel.getLeftBottomPoint().x + ":" + dataModel.getLeftBottomPoint().y);
        System.out.println("Right top point: " + dataModel.getRightTopPoint().x + ":" + dataModel.getRightTopPoint().y);
        System.out.println("Right bottom poiny: " + dataModel.getRightBottomPoint().x + ":" + dataModel.getRightBottomPoint().y);
