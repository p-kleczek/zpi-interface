...
public class ManageHallsFrame extends JFrame {
    ...
    public ManageHallsFrame(ArrayList<Hall> list) {
        ...
        gridButton.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                if (selectedRow != -1)
                    new HallFrame(getHallByIndex(selectedRow));
            }
    ...
    public void setDetailText(int hallIndex) {
        detailsPanel.setupText(getHallByIndex(hallIndex));
        repaint();
    }
    ...
    public Hall getHallByIndex(int hallIndex) {
        return hallList.get(hallIndex);
    }
}
